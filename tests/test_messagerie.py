...
PIXEL = base64.b64encode(bytes.fromhex(
    ...
    "ffffffffffffffffffffffffffffffffffffffffc00011080001000101011100ffc4001f00"
    ...
    "dae1e2e3e4e5e6e7e8e9eaf1f2f3f4f5f6f7f8f9faffda000c03010002110311003f00fbfa28"
    "a2803fffd9")).decode()
